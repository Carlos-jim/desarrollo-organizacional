            ...
            <div className="space-y-4">
              ...
              {nucleo.actividades?.map((actividad, index) => (
                <div key={index} className="border rounded p-4 bg-white shadow mb-4">
                  ...
                  {typeof actividad.contenido === "string" && actividad.contenido.endsWith(".png") && (
                    <Image src={actividad.contenido} alt={actividad.tipo} width={400} height={300} />
                  )}
                  {typeof actividad.contenido === "string" && actividad.contenido.endsWith(".mp4") && (
