        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Evalúa tu progreso y recibe retroalimentación personalizada</p>
            </div>
              ...
              <TabsContent value="proyectos" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Desarrolla proyectos prácticos aplicando los conceptos aprendidos</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid gap-4">
                      <div className="p-4 border rounded-lg">
                        <h4 className="font-semibold mb-2">Diagnóstico Organizacional</h4>
                        <p className="text-sm text-gray-600 mb-3">
                          Realiza un diagnóstico completo de una organización real o ficticia
                        </p>
                      ...
                      <div className="p-4 border rounded-lg">
                        <h4 className="font-semibold mb-2">Plan de Intervención</h4>
                        <p className="text-sm text-gray-600 mb-3">
                          Diseña un plan de intervención para el cambio organizacional
                        </p>
                        <div className="flex justify-between items-center">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg">
                          <h4 className="font-semibold text-blue-800 mb-2">Áreas de Mejora</h4>
